...
const struct frr_yang_module_info frr_bgp_route_map_info = {
	...
	.nodes = {
		...
		},
		{
			...
			.cbs = {
				.modify = lib_route_map_entry_match_condition_rmap_match_condition_nexthop_fanout_modify,
				.destroy = lib_route_map_entry_match_condition_rmap_match_condition_nexthop_fanout_destroy,
			}
		},
		{
